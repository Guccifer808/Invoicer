function DeleteModal({ invoiceId, onDeleteButtonClick, setIsDeleteModalOpen }) {
  return (
    ...
    >
      ...
      <div className="text-black mx-auto my-auto  max-h-[95vh]  w-full max-w-md overflow-y-scroll rounded-xl bg-light px-8 py-8 font-bold shadow-md  shadow-[#364e7e1a] scrollbar-hide  dark:bg-[#2b2c37] dark:text-light ">
