...
const InvoiceCard = ({ invoice }: Props) => {
  return (
    <Link to={`invoice?${invoice.id}`}>
      {/* Desktop */}
      <div className="border-transparent hidden cursor-pointer items-center justify-between rounded-lg bg-light px-6 py-4 shadow-sm duration-300 ease-in-out hover:border hover:border-accentColor dark:bg-dark md:flex">
      ...
      {/* Phone Screen */}
      <div className="border-purple-500 flex cursor-pointer items-center justify-between rounded-lg bg-light px-6 py-4 shadow-sm hover:border  dark:bg-[#1E2139] md:hidden">
